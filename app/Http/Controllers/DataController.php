      ...
      if(isset($user)){
        ...
        foreach ($labels as $label) {
          ...
          $user_labels[] = [
            ...
            'text'                  => $label->name,
            'type'                  => $label->type,
            'labelListVisibility'   => $label_data ? $label_data->labelListVisibility : $label->labelListVisibility,
            'messageListVisibility' => $label_data ? $label_data->messageListVisibility : $label->messageListVisibility,
